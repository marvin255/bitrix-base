...
return [
    ...
    'connections'      => [
        'dev' => [
            'host'      => 'заменить на домен на тестовом сервере',
            'username'  => 'заменить на пользователя на тестовом сервере',
            'password'  => 'заменить на пароль на тестовом сервере',
            'key'       => '',
            'keyphrase' => '',
            'agent'     => '',
            'db_role'   => true,
        ...
        'prod' => [
            'host'      => 'заменить на домен на боевом сервере',
            'username'  => 'заменить на пользователя на боевом сервере',
            'password'  => 'заменить на пароль на боевом сервере',
            'key'       => '',
            'keyphrase' => '',
            'agent'     => '',
            'db_role'   => true,
